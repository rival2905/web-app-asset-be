<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bold ms-2">THL Presensi</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item @if(setActive('admin/recapitulation')) active open @endif">
        ...
        <ul class="menu-sub"> 
          <li class="menu-item @if(setActive('admin/recapitulation/daily')) active @endif">
            <a href="{{ route('admin.rekap.daily') }}" class="menu-link">
              <div class="text-truncate" data-i18n="Basic Inputs">Daily</div>
            </a>
          </li>
          <li class="menu-item @if(setActive('admin/recapitulation/monthly')) active @endif">
            <a href="{{ route('admin.rekap.monthly') }}" class="menu-link">
              <div class="text-truncate" data-i18n="Basic Inputs">Monthly</div>
            </a>
          </li>
          
          <li class="menu-item @if(setActive('admin/recapitulation/advanced')) active @endif">
            <a href="{{ route('admin.rekap.advanced') }}" class="menu-link">
      ...
      <!-- Data Rekapitulation -->
      @else
      <li class="menu-item @if(setActive('rekap')) active open @endif">
        <a href="{{ route('rekap.myprofile',Crypt::encryptString(Auth::user()->id)) }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-table"></i>
          <div class="text-truncate" data-i18n="Tables">Rekapitulasi</div>
        </a>
      </li>
      @endif
      <!-- Tables -->
